...
export class Backend implements backendInterface {
    ...
    async addProperty(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProperty(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPlanById(arg0: string): Promise<Plan> {
        if (this.processError) {
            try {
    ...
    async updateServiceRequestStatus(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async uploadPhoto(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
